...
app/                  --> all of the source files for the application
  ...
  composition/                --> the composition view template and logic
    composition.html            --> the partial template
    composition.js              --> the controller logic
    composition_test.js         --> tests of the controller
  musicList/                --> the musicList view template and logic
    musicList.html            --> the partial template
    musicList.js              --> the controller logic
    musicList_test.js         --> tests of the controller
